function carregaDicionario() {
   var biografias = {
    bio01: {
        ...
        citaçao:  "Quantos mais vão precisar morrer para que essa guerra aos pobres acabe?",
    },
    bio02: {
        nome: "Lelia Gonzalez",
        imagem: "img/lelia-gonzalez.jpg",
        ...
        citaçao: "A gente não nasce negro, a gente se torna negro. É uma conquista dura, cruel e que se desenvolve pela vida da gente afora.",
    },
    bio03: {
        nome:"Angela Davis",
        imagem: "img/angela-davis.jpg",
        ...
        citaçao: "Não aceito mais as coisas que não posso mudar, estou mudando as coisas que não posso aceitar.",
    },
    bio04: {
        nome: "Conceição Evaristo",
        imagem: "img/conceição-evaristo.jpg",
        ...
        citaçao: "O importante não é ser o primeiro ou primeira, o importante é abrir caminhos.",
    },
    bio05: {
        nome: "Carolina de Jesus",
        imagem: "img/carolina-de-jesus.jpeg",
        ...
        citaçao: "Ah, comigo o mundo vai modificar-se. Não gosto do mundo como ele é.",
    },
    bio06: {
        nome: "Rosa Parks",
        imagem: "img/rosa-parks.jpg",
        ...
        citaçao: "Você nunca deve ter medo do que está fazendo quando está certo.",
       },
   };
   ...
   for (var bio in biografias){
    console.log(
        (bio +=
            ...
            " " +
            "Minibio: " +
            biografias [bio].descriçao +
            " " +
            "Citação: " +
            biografias [bio].citaçao)
    );
   }
